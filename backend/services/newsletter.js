      ...
      return `
        <div class="story-item" style="break-inside: avoid; margin-bottom: 25px; padding-bottom: 20px; border-bottom: 2px solid #ddd;">
          ...
          <div style="margin: 8px 0; font-size: 18px;">
            <a href="https://newswatch.popk.in/vote?storyId=${story.id}&rating=up" target="_blank" style="text-decoration: none; margin-right: 12px; display: inline-flex; align-items: center; gap: 4px;" title="More like this">
            ...
            <a href="https://newswatch.popk.in/vote?storyId=${story.id}&rating=down" target="_blank" style="text-decoration: none; display: inline-flex; align-items: center; gap: 4px;" title="Less like this">
