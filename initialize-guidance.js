...
async function initializeGuidance() {
    const initialGuidance = `Prioritize valuation and analysis of enterprise SaaS (Software-as-a-Service) businesses with ARR > $10M, applying standard private equity analysis best practices (e.g., unit economics, retention/cohort analysis, revenue quality, growth sustainability, margin structure, and cash flow conversion).
