...
- Present an archive of each day's newsletter.
...
- All delivery should be via static files, to minimize hosting costs. So the system should run hourly to check for new articles, analyze them, and update the static web site. he system will be deployed to run on GCP under their free tier.
